...
-- vim.api.nvim_set_keymap('n', '<C-h>', [[<cmd>lua require("harpoon.ui").nav_file(1)<cr>]],
--     { noremap = true, silent = true })
-- vim.api.nvim_set_keymap('n', '<C-t>', [[<cmd>lua require("harpoon.ui").nav_file(2)<cr>]],
--     { noremap = true, silent = true })
-- vim.api.nvim_set_keymap('n', '<C-n>', [[<cmd>lua require("harpoon.ui").nav_file(3)<cr>]],
--     { noremap = true, silent = true })
-- vim.api.nvim_set_keymap('n', '<C-s>', [[<cmd>lua require("harpoon.ui").nav_file(4)<cr>]],
--     { noremap = true, silent = true })
